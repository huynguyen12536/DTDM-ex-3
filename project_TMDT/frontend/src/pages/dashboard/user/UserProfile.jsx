    ...
    <div className="container mx-auto p-6">
      <div className="bg-white shadow-md rounded-lg p-6">
        <div className="flex items-center mb-4">
          ...
          />
          <div className="ml-6">
            <h2 className="text-2xl font-bold">Tên người dùng: {formData.username || 'Chưa có'}</h2>
            <p className="text-gray-700">Tiểu sử: {formData.bio || 'Chưa có'}</p>
            <p className="text-gray-700">Nghề nghiệp: {formData.profession || 'Chưa có'}</p>
          </div>
          <button
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg md:w-96 max-w-xl mx-auto relative">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label htmlFor="profileImage" className="block text-sm font-medium text-gray-700">URL ảnh đại diện</label>
                <input
                  type="text"
                  name="profileImage"
              ...
              <div className="mb-4">
                <label htmlFor="profession" className="block text-sm font-medium text-gray-700">Nghề nghiệp</label>
                <input
                  type="text"
                  name="profession"
              ...
              {isError && <p className="mt-2 text-red-500">Cập nhật hồ sơ thất bại. Vui lòng thử lại.</p>}
              {isSuccess && <p className="mt-2 text-green-500">Cập nhật hồ sơ thành công!</p>}
            </form>
          </div>
        </div>
      )}
