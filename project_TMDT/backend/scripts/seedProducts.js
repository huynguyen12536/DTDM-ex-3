...
const productsData = [
  ...
  { name: "Evening Gown", category: "dress", description: "Elegant evening gown for special occasions.", price: 149.99, oldPrice: 199.99, image: "https://images.pexels.com/photos/988872/pexels-photo-988872.jpeg?auto=compress&cs=tinysrgb&w=800", color: "red", rating: 4.0 },
  ...
  { name: "Cocktail Dress", category: "dress", description: "Chic cocktail dress for parties and events.", price: 89.99, image: "https://images.pexels.com/photos/1986993/pexels-photo-1986993.jpeg?auto=compress&cs=tinysrgb&w=800", color: "black", rating: 4.4 },
  { name: "Diamond Earrings", category: "jewellery", description: "Sparkling diamond earrings that add elegance to any outfit.", price: 299.99, oldPrice: 349.99, image: "https://images.pexels.com/photos/1578993/pexels-photo-1578993.jpeg?auto=compress&cs=tinysrgb&w=800", color: "silver", rating: 4.8 },
  ...
  { name: "Designer Wallet", category: "accessories", description: "Premium leather wallet with multiple card slots.", price: 69.99, oldPrice: 89.99, image: "https://images.pexels.com/photos/1050036/pexels-photo-1050036.jpeg?auto=compress&cs=tinysrgb&w=800", color: "brown", rating: 4.4 },
  ...
  { name: "Leather Belt", category: "accessories", description: "Classic leather belt with adjustable buckle.", price: 39.99, image: "https://images.pexels.com/photos/808412/pexels-photo-808412.jpeg?auto=compress&cs=tinysrgb&w=800", color: "black", rating: 4.2 },
  ...
  { name: "Eyeshadow Palette", category: "cosmetics", description: "12-color eyeshadow palette with matte and shimmer shades.", price: 34.99, oldPrice: 49.99, image: "https://images.pexels.com/photos/3373749/pexels-photo-3373749.jpeg?auto=compress&cs=tinysrgb&w=800", color: "multi", rating: 4.4 },
  ...
  { name: "Floral Print Dress", category: "dress", description: "Beautiful floral print dress for spring and summer.", price: 69.99, image: "https://images.pexels.com/photos/2065197/pexels-photo-2065197.jpeg?auto=compress&cs=tinysrgb&w=800", color: "multi", rating: 4.6 },
  ...
  { name: "Charm Bracelet", category: "jewellery", description: "Delicate charm bracelet with multiple charms.", price: 159.99, image: "https://images.pexels.com/photos/1452684/pexels-photo-1452684.jpeg?auto=compress&cs=tinysrgb&w=800", color: "silver", rating: 4.7 },
  { name: "Concealer", category: "cosmetics", description: "Full-coverage concealer for blemishes and dark circles.", price: 27.99, image: "https://images.pexels.com/photos/3738370/pexels-photo-3738370.jpeg?auto=compress&cs=tinysrgb&w=800", color: "beige", rating: 4.3 },
  ...
  { name: "Emerald Ring", category: "jewellery", description: "Stunning emerald ring set in white gold.", price: 399.99, oldPrice: 449.99, image: "https://images.pexels.com/photos/3641040/pexels-photo-3641040.jpeg?auto=compress&cs=tinysrgb&w=800", color: "green", rating: 4.9 },
  ...
  { name: "Bodycon Dress", category: "dress", description: "Fitted bodycon dress for a sleek silhouette.", price: 84.99, image: "https://images.pexels.com/photos/2899712/pexels-photo-2899712.jpeg?auto=compress&cs=tinysrgb&w=800", color: "black", rating: 4.5 },
  ...
  { name: "Highlighter", category: "cosmetics", description: "Luminous highlighter for a radiant glow.", price: 26.99, image: "https://images.pexels.com/photos/3373747/pexels-photo-3373747.jpeg?auto=compress&cs=tinysrgb&w=800", color: "gold", rating: 4.4 },
  ...
  { name: "Anklet", category: "jewellery", description: "Delicate anklet with small charms.", price: 49.99, image: "https://images.pexels.com/photos/1006924/pexels-photo-1006924.jpeg?auto=compress&cs=tinysrgb&w=800", color: "silver", rating: 4.3 },
